<footer class="site-footer">
    <div class="container">
        <div class="row">
            <div class="col-lg-4 col-md-6 col-12 mb-4" style="color:white;">
                <h5 class="site-footer-title mb-3">{{ $views->contact_title }}</h5>
            ...
            <div class="col-lg-4 col-md-6 col-12 mx-auto">
                ...
                <p class="text-white d-flex mb-2">
                    ...
                    <a href="tel: 305-240-9671" class="site-footer-link">{{ $views->contact_phone_number }}</a>
                </p>

                <p class="text-white d-flex">
                    <i class="bi-envelope me-2"></i>
                    <a href="mailto:{{ $views->contact_email }}" class="site-footer-link">{{ $views->contact_email }}</a>
                </p>
            ...
            <div class="row">
                <div class="col-lg-6 col-md-7 col-12">
                    <p class="copyright-text mb-0">
                        Copyright © 2036 <a href="#">Kind Heart</a> Charity Org. Design: <a href="https://templatemo.com" target="_blank">TemplateMo</a><br>Distribution: <a href="https://themewagon.com">ThemeWagon</a>
                    </p>
                </div>
