    ...
    <div class="d-flex flex-column min-vh-100" style="background-color: #fdfaf4;">
        ...
        <main class="flex-grow-1 d-flex justify-content-center align-items-center">
            <div class="container text-center pb-2">
                ...
                <div class="row g-5 align-items-center d-flex {{ $historic->order % 2 == 0 ? 'hiseven' : 'hisodd' }}">
                    ...
                    <div class="col-lg-7 wow fadeInUp" data-wow-delay="0.1s">
                        <p style="text-align: justify;">{{ $historic->content }}</p>
                    </div>
                </div>
                @endforeach
                ...
                <div class="row mt-5">
                    ...
                    <div class="row mt-5">
                        <div class="col">
                            <div class="d-flex flex-column-reverse flex-lg-row justify-content-between align-items-start" id="flexmaker">
...
window.addEventListener('resize', function () {
    const flexMaker = document.getElementById('flexmaker');
    const whenSmall = document.getElementById('whenSmall');

    if (window.innerWidth > 992) {
        // For larger screens
        if (flexMaker) {
            flexMaker.classList.add('d-flex', 'flex-column-reverse', 'flex-lg-row', 'justify-content-between', 'align-items-start');
        }
        if (whenSmall) {
            whenSmall.innerHTML = ''; // Clear content of #whenSmall
        }
    } else {
        // For smaller screens
        if (flexMaker) {
            flexMaker.classList.remove('d-flex', 'flex-column-reverse', 'flex-lg-row', 'justify-content-between', 'align-items-start');
        }
        if (whenSmall) {
            whenSmall.innerHTML = `
                <div class="col-lg-6"></div>
                <div class="judul-misi col-lg-6 mb-3">
                    <h3>Misi (Mission)</h3>
                </div>
            `;
        }
